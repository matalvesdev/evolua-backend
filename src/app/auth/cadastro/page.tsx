      ...
      <GlassCard>
        <div className="flex flex-col items-center gap-4 py-4">
          <div className="p-4 bg-purple-50 rounded-full mb-2">
            <HandMetal className="size-9 text-primary" />
          </div>
        ...
        <Button
          onClick={handleStart}
          size="lg"
          className="w-full md:w-auto bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-4 px-10 rounded-full shadow-[0_8px_25px_rgba(164,19,236,0.3)] hover:shadow-[0_10px_30px_rgba(164,19,236,0.5)] transform hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 text-lg h-auto"
        >
