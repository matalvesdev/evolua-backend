    ...
    >
      ...
      <div className="mt-8 flex justify-between">
        ...
        <Button
          ...
          size="lg"
          className="group bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-4 px-10 rounded-full shadow-[0_8px_25px_rgba(164,19,236,0.3)] hover:shadow-[0_10px_30px_rgba(164,19,236,0.5)] transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 text-lg h-auto"
        >
          Continuar
