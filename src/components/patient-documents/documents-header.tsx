  ...
  return (
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
      ...
      <div className="glass-card rounded-2xl p-4 flex items-center gap-4 shadow-sm min-w-[240px] border border-white">
        <div className="size-10 rounded-full bg-[#820AD1]/10 flex items-center justify-center text-[#820AD1]">
        ...
        <div className="flex-1">
          ...
          <div className="w-full h-1.5 bg-gray-200 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#820AD1] to-purple-400 rounded-full"
