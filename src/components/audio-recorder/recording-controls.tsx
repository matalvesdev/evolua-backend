  ...
  return (
    <div className="flex items-center gap-8 md:gap-12 mb-8 w-full justify-center">
      ...
      <button
        ...
        className="relative w-20 h-20 md:w-24 md:h-24 rounded-full bg-[#820AD1] shadow-[0_4px_20px_rgba(130,10,209,0.3)] flex items-center justify-center hover:shadow-[0_4px_30px_rgba(130,10,209,0.5)] transition-all hover:scale-105 active:scale-95 z-10 pulse-animation"
      >
      ...
      <style jsx>{`
        @keyframes pulse-ring {
          0% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(130, 10, 209, 0.7); }
          70% { transform: scale(1); box-shadow: 0 0 0 20px rgba(130, 10, 209, 0); }
          100% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(130, 10, 209, 0); }
        }
        .pulse-animation {
